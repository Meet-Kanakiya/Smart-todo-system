    ...
    <div className="planner-container">
      <div className="planner-card">
        ...
        <form onSubmit={add} className="planner-form">
          ...
          <select className="planner-select" value={day} onChange={(e) => setDay(e.target.value)}>
        ...
        {activeDays.length === 0 ? (
          <p className="planner-empty">No tasks yet — add your first one above!</p>
        ) : (
            ...
            {activeDays.map((d) => {
              ...
              return (
                <div key={d} className="planner-day">
                  <strong className="planner-day-title">{d}</strong>
                  ...
                  {items.map((it) => (
                    ...
                    >
                      ...
                      <button onClick={() => remove(it.id)} className="planner-delete-btn">
                        Delete
                      </button>
                    </motion.div>
                  ))}
